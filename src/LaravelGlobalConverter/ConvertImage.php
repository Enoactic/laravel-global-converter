...
class ConvertImage
{
    public static function iosPNGToPNG($filename, $destination = null)
    {
        try {
            ...
            $newPng = self::getNormalPNG($oldPNG);
            if (is_null($destination))
                $destination = $filename;

            file_put_contents($destination, $newPng);
        } catch (Exception $exc) {
    ...
    public static function getNormalPNG($oldPNG)
    {
